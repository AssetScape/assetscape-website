  ...
  sections: [
    {
      h: 'Approach',
      p: [
        'AssetScape data cleansing module - 2D version utilises mapping and imagery to cleanse data in a 2D environment',
        'The system enables the process team to create, verify and audit assets in a specific data cleansing module. The module enables the project manager to track progress, answer questions and sign off every asset. All decisions are tracked as part of the timeline feature and can be reviewed at any time.',
        ' ',
        ...
        ' ',
        'AssetScape data cleansing module - 3D version:',
        'Utilises LiDAR, DTM, mapping and imagery to cleanse data in a 3D environment',
        ...
        'Provision of mobile solution connected to AssetScape’s instance of the project on request for on-site verification and additional surveying.',
      ],
    },
    {
      h: 'Data inputs',
    ...
    },
    {
      ...
      p: [
        ...
        'Fully auditable data cleansing datasets that can be reviewed, integrated and used to maintain or add to in the future.',
      ],
    },
  ],
